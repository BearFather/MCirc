...
//Start of the catching of the name.
		...
		elseif (preg_match("/PRIVMSG $this->server_chan :/", $out) && $mname != $this->nick){
			...
			elseif ($mname=="MAIN" || $mname=="RPG" || $mname=="Tekkit"){
				$xmsg[1]=trim($xmsg[1]);
			...
			else {echo "<span id=site>WWW</span>:(<span id=author>".$mname."</span>) ".$xmsg[1];}
		}
